...
const steps = [
  "Surface preparation",
  "Primer application",
  "Concrete Optik application",
  "Application of MT-OPTIK-PP sheets",
  "After 24 hours, sheets removal",
  "After 24 hours, sealer application",
];

export default function ConcreteOptikHow() {
  return (
    <section className="bg-[#f0ece6] px-6 py-16 sm:px-10 lg:px-16 lg:py-24 md:mx-[15px] md:[width:calc(100%-30px)] mt-0">
      ...
      <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(390px,0.95fr)] lg:gap-20">
        <Image src="/images/concrete-optik/how.png" alt="Concrete Optik application diagram" width={1185} height={1035} className="h-auto w-full" sizes="(min-width: 1024px) 52vw, 100vw" />
