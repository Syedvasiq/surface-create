...
export default function MicrotoppingContinuousSpace() {
  return (
    <section className="bg-white mt-[15px] py-14 md:py-20 md:mx-[15px] md:[width:calc(100%-30px)]">
      <div className="flex flex-col md:flex-row md:items-center gap-10 md:gap-0">
        ...
        <div className="w-full md:w-[38%] shrink-0 px-5 sm:px-10 lg:px-14">
          ...
          <div className="space-y-4 mb-8 md:mb-10">
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">
              Surface Crete Microtopping is perfect for those who want a
              continuous, innovative and tactile surface that can make any
              space unique, whether it is a minimal modern environment where
              Microtopping stands out as the main feature, or a classic,
              rustic or vintage environment, where it completes the style
              with refined discretion.
            </p>
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">
              You can customise Microtopping by choosing shades and
              creating glossy, clouded, or acid stained effects to make it
              exactly the way you want it.
            </p>
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">
              Suitable for floors, walls, ceilings and furniture, Microtopping
              adheres directly over existing surfaces &mdash; no demolition, no waste,
              no disruption to your space.
            </p>
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">
              With a thickness of just 3 mm, it is the ideal solution for
              renovation projects where preserving existing levels and finishes
              is essential.
            </p>
          </div>

          <Link
            href="/microtopping/unrepeatable-beauty"
        ...
        <div className="w-full md:w-[62%] relative aspect-[4/3] md:aspect-auto md:h-[420px] lg:h-[500px] overflow-hidden">
          <Image
            src="/microtopping-exterior.jpg"
            alt="Microtopping exterior surface finish"
            fill
