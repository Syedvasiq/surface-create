...
export default function StenciltopContinuousSpace() {
  return (
    <section className="bg-white mt-[15px] py-14 md:py-20 md:mx-[15px] md:[width:calc(100%-30px)]">
      <div className="flex flex-col md:flex-row md:items-center gap-10 md:gap-0">
        <div className="w-full md:w-[38%] shrink-0 px-5 sm:px-10 lg:px-14">
          ...
          <div className="space-y-4 mb-8 md:mb-10">
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">
              Looking to improve the appearance of an existing hardstanding or patio with new colours, patterns and textures? With Surface Crete Stenciltop you can — easily, quickly and with the minimum of dirt and disruption.
            </p>
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">
              Stenciltop is the perfect treatment for renovating and beautifying existing concrete slabs with minimal alteration to surface levels. Stenciltop is ideal for renewing and refurbishing pathways, patios, pool decks, street pavements and access ramps.
            </p>
          </div>
        ...
        <div className="w-full md:w-[62%] relative aspect-[4/3] md:aspect-auto md:h-[420px] lg:h-[500px] overflow-hidden">
          <Image src="/images/stenciltop/stenciltop-continus-space.jpg" alt="Stenciltop floor surface" fill className="object-cover" sizes="(max-width: 768px) 100vw, 62vw" />
        </div>
      </div>
    </section>
  );
