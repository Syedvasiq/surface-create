...
export default function WallMicrotoppingDesignSections() {
  return (
    <section className="bg-white md:mx-[15px] md:[width:calc(100%-30px)] mt-[15px]">
      ...
      {/* 2. From continuity to your ideas */}
      <div className="flex flex-col md:flex-row-reverse md:items-start gap-10 md:gap-0 py-10 md:py-14 border-t border-gray-100">
        <div className="w-full md:w-[50%] shrink-0 px-5 sm:px-10 lg:px-14 py-10 md:py-0">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">Its extraordinary features make it ideal for both horizontal and vertical surfaces, such as plasterboard or masonry walls, stairs, bathrooms and shower enclosures. Microtopping® gives space to your ideas without interrupting lines.</p>
          </div>
        </div>
        <div className="w-full md:w-[50%] relative aspect-[4/3] md:aspect-auto md:h-[420px] lg:h-[480px] overflow-hidden shrink-0">
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-10 md:gap-0 py-10 md:py-14 border-t border-gray-100">
        <div className="w-full md:w-[50%] shrink-0 px-5 sm:px-10 lg:px-14 py-10 md:py-0">
          ...
          <h3 className="text-[22px] sm:text-[26px] lg:text-[30px] font-light text-gray-900 leading-snug mb-5">Colours, effects, finishes… the aesthetic of cement has no limits</h3>
          <div className="space-y-4">
            ...
            <p className="text-[14px] sm:text-[15px] text-gray-700 leading-[1.85]">It is possible to achieve glossy, clouded or acidified effects and create velvets and decorative inserts for unique, personalised finishes, with great aesthetic impact and elegance.</p>
          </div>
        </div>
        <div className="w-full md:w-[50%] relative aspect-[4/3] md:aspect-auto md:h-[420px] lg:h-[480px] overflow-hidden shrink-0">
