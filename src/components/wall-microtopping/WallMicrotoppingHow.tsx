        ...
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(390px,0.95fr)] lg:gap-20">
          ...
          <div className="text-[#1d2830]">
            ...
            <ol className="space-y-4 text-[17px] leading-snug sm:text-lg">
              ...
              <li className="flex gap-1.5"><span className="font-semibold shrink-0">3.</span><span>Application of Microtopping BC in 2 coats</span></li>
            </ol>
            ...
            <div className="mt-8 pt-8 border-t border-gray-300">
              ...
              <ol className="space-y-4 text-[17px] leading-snug sm:text-lg" start={4}>
                ...
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">5.</span><span>Application 1st coat of Microtopping FC</span></li>
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">6.</span><span>Sanding and cleaning of the surface</span></li>
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">7.</span><span>Application of SC PU WB Easy</span></li>
              </ol>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-300">
              ...
              <ol className="space-y-4 text-[17px] leading-snug sm:text-lg" start={4}>
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">4.</span><span>Sanding and cleaning of the surface</span></li>
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">5.</span><span>Application of Microtopping HP</span></li>
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">6.</span><span>Sanding and cleaning of the surface</span></li>
                <li className="flex gap-1.5"><span className="font-semibold shrink-0">7.</span><span>Application of SC PU WB Easy</span></li>
              </ol>
            </div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(390px,0.95fr)] lg:gap-20">
          ...
          <div className="text-[#1d2830]">
            ...
            <ol className="space-y-4 text-[17px] leading-snug sm:text-lg">
              ...
              <li className="flex gap-1.5"><span className="font-semibold shrink-0">3.</span><span>Application of Microtopping BC 1 coat</span></li>
              <li className="flex gap-1.5"><span className="font-semibold shrink-0">4.</span><span>Application of Microtopping HP</span></li>
              <li className="flex gap-1.5"><span className="font-semibold shrink-0">5.</span><span>Application of Microtopping FC</span></li>
              <li className="flex gap-1.5"><span className="font-semibold shrink-0">6.</span><span>Sanding and application of protective sealer SC PU WB Easy</span></li>
            </ol>
          </div>
        </div>
