...
const steps = [
  "Surface preparation",
  "Concrete placing and levelling",
  "Application and incorporation of Colour Hardener",
  "Finishing and smoothing of the surface",
  "Application of the Powder release agent",
  "Imprinting and finishing",
  "Washing of the surface",
  "Application of a protective sealer",
];

export default function StampedConcreteHow() {
  return (
    <section className="bg-[#f0ece6] px-6 py-16 sm:px-10 lg:px-16 lg:py-24 md:mx-[15px] md:[width:calc(100%-30px)] mt-0">
      ...
      <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(390px,0.95fr)] lg:gap-20">
        <Image src="/images/stamped-concrete/how.png" alt="Stamped concrete application diagram" width={1185} height={1035} className="h-auto w-full" sizes="(min-width: 1024px) 52vw, 100vw" />
