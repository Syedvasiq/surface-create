...
export default function RenovationBeforeAfter() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-white md:mx-[15px] mt-[15px] mb-[5px] pb-[15px]"
      style={{ height: "220vh" }}
    >
      <div className="sticky top-0 h-screen w-full flex flex-col md:flex-row overflow-hidden">

        {/* ── Left: Text content ── */}
        <div className="w-full md:w-[32%] shrink-0 flex flex-col justify-center px-5 sm:px-10 lg:px-14 py-8 md:py-0 bg-white">
          <p className="text-[11px] tracking-widest text-gray-400 uppercase mb-4">
            Before &amp; After
          </p>
          <h2 className="text-2xl sm:text-3xl lg:text-[42px] font-light text-gray-900 leading-tight mb-5">
            Perfect for renovation<br />and restoration
          </h2>
          <p className="text-[13px] md:text-[14px] text-gray-600 leading-relaxed mb-5 max-w-sm">
            ...
            {categories.map((cat, i) => {
              ...
              return (
                <Link
                  key={cat}
                  href="#"
                  className={`text-[14px] md:text-[15px] py-1.5 transition-all duration-500 ${
                    visible
          ...
          >
            <span className="flex items-center justify-center w-7 h-7 rounded-full border border-gray-400 shrink-0 group-hover:border-gray-700 group-hover:bg-gray-700 group-hover:text-white transition-colors">
        ...
        <div className="relative w-full md:w-[68%] h-[50vw] md:h-full overflow-hidden">
