...
export const metadata: Metadata = {
  ...
  description: "Polished concrete floors and surfaces for a premium restaurant in Chennai by Surface Crete.",
  alternates: { canonical: "/projects/premium-restaurant-chennai" },
};

const images = [
  { src: "/images/projects/premium reaturant in chennai/premium-restaurant-inchennai-exterior.png", alt: "Exterior" },
  { src: "/images/projects/premium reaturant in chennai/premium-restaurant-inchennai-interior.png", alt: "Interior" },
  { src: "/images/projects/premium reaturant in chennai/premium-restaurant-inchennai-inside.png", alt: "Inside view" },
];
    ...
    <main className="flex flex-1 flex-col bg-white">
      ...
      <div className="max-w-[1200px] mx-auto w-full px-6 py-12">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-12 border-b border-gray-200 pb-10">
          <div>
            <p className="text-[11px] uppercase tracking-widest text-gray-400 mb-2">Polished Concrete</p>
            <h1 className="text-[32px] sm:text-[42px] font-light text-gray-900 leading-tight mb-4">Premium Restaurant, Chennai</h1>
            <p className="text-[14px] text-gray-600 leading-relaxed max-w-xl">
              A high-end dining destination in Chennai finished with polished concrete floors
              throughout. Surface Crete ground, honed and polished the concrete to a refined
              matte sheen — creating a durable, sophisticated surface that sets the tone for
              the entire dining experience and withstands heavy commercial footfall.
            </p>
          </div>
          <div className="shrink-0 flex flex-col gap-3 text-[13px] text-gray-600 md:text-right">
            <div><span className="font-semibold text-gray-900 block">Location</span>Chennai, India</div>
            <div><span className="font-semibold text-gray-900 block">Surface</span>Polished Concrete</div>
            <div><span className="font-semibold text-gray-900 block">Application</span>Floors · Feature Walls</div>
          </div>
        </div>
